            ...
            {user ? (
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="hidden sm:flex items-center gap-2 bg-slate-800/90 hover:bg-slate-700/90 border border-slate-700 text-xs font-semibold px-3 py-2 rounded-xl transition text-slate-200"
                >
                  ...
                  <span>{googleLoading ? 'Đang vào...' : 'Đăng nhập Google'}</span>
                </button>

                <Link
                  href="/login"
                  className="text-xs font-semibold bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-500 hover:to-rose-400 px-4 py-2 rounded-xl transition shadow-lg shadow-rose-600/30 text-white"
                >
                  Tài khoản
                </Link>
              </div>
